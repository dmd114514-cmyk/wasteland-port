...
import dev.vanilladev.wasteland.Wasteland;
...
public class WorldGenWastelandBigTree extends WorldGenBigTree
{
		...
		for (var11[par5] = var10[par5]; var12 <= var7; ++var12)
		{
			...
			while (var13 <= var7)
			{
				...
				else
				{
					...
					{
						this.setBlockAndNotifyAdequately(worldObj, new BlockPos(var11[0], var11[1], var11[2]), par6.getStateFromMeta(0));
						++var13;
					}
				}
			}
	...
	void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, Block par3)
	{
		...
		if (var4[var6] != 0)
		{
			...
			for (int var16 = var4[var6] + var9; var15 != var16; var15 += var9)
			{
				...
				this.setBlockAndNotifyAdequately(worldObj, new BlockPos(var14[0], var14[1], var14[2]), par3.getStateFromMeta(var17));
			}
		}
	}
	...
	void generateLeaves()
	{
		...
		{
			int var3 = nodes[var1][0];
			int var4 = nodes[var1][1];
			int var5 = nodes[var1][2];
	...
	int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger)
	{
		...
		else
		{
			...
			for (var15 = var3[var5] + var8; var14 != var15; var14 += var8)
			{
				...
				Block var16 = worldObj.getBlockState(new BlockPos(var13[0], var13[1], var13[2])).getBlock();
	...
	boolean validBigTreeLocation()
	{
		...
		//{
			Block var3 = worldObj.getBlockState(new BlockPos(basePos[0], basePos[1] - 1, basePos[2])).getBlock();
