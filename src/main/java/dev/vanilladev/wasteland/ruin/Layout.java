...
public class Layout 
{
	...
	public Layout(World world, Random rand, Building center, Building[] structures, int vPosX, int vPosZ, int dim, int size)
	{
		...
		if (center != null)
		{
			...
			this.cPos = new Rectangle(new Vector(vPosX-offsetX, world.getHeight(vPosX-offsetX, vPosZ-offsetZ) - 1, 
	...
	public static int getWorldHeight(World world, int x, int z)
	{
		...
		Block block = world.getBlockState(new BlockPos(x, worldHeight, z)).getBlock();
		if (worldHeight == 0) 
		{
