...
public class RuinRuinedCiv2 extends Ruin implements IWorldGenerator
{
	...
	public boolean generate(World world, Random random, int i, int j, int k)
	{
		...
		int j1 = 0;
		int k1 = 0;
		Material material = world.getBlockState(new BlockPos(i, j, k)).getMaterial();
		Material material1 = world.getBlockState(new BlockPos(i, j - 1, k)).getMaterial();
		Material material2 = world.getBlockState(new BlockPos(i + 6, j, k)).getMaterial();
		Material material3 = world.getBlockState(new BlockPos(i, j, k + 6)).getMaterial();
		Material material4 = world.getBlockState(new BlockPos(i + 6, j, k + 6)).getMaterial();
		Material material5 = world.getBlockState(new BlockPos(i, j + 1, k)).getMaterial();
		Material material6 = world.getBlockState(new BlockPos(i + 6, j + 1, k)).getMaterial();
		Material material7 = world.getBlockState(new BlockPos(i, j + 1, k + 6)).getMaterial();
		Material material8 = world.getBlockState(new BlockPos(i + 6, j + 1, k + 6)).getMaterial();
