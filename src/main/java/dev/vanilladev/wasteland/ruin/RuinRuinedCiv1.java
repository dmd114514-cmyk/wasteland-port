			...
			if (flag1)
			{
				...
				if (!flag2)
				{
					...
					if (k4 == 0)
					{
						...
						TileEntityChest chest = (TileEntityChest) world.getTileEntity(new BlockPos(x + k8, y - 3, z + j9));
					...
					for (int j5 = 0; j5 < 3; j5++)
					{
						...
						for (int i8 = 0; i8 < 28; i8++)
						{
							...
							if (j6 == 0)
							{
								Material material9 = world.getBlockState(new BlockPos(x, y + j5, z + i7)).getMaterial();
							...
							if (j6 == 1)
							{
								Material material10 = world.getBlockState(new BlockPos(x + 6, y + j5, z + i7)).getMaterial();
							...
							if (j6 == 2)
							{
								Material material11 = world.getBlockState(new BlockPos(x + i7, y + j5, z)).getMaterial();
							...
							if (j6 == 3)
							{
								Material material12 = world.getBlockState(new BlockPos(x + i7, y + j5, z + 6)).getMaterial();
					...
					TileEntityChest chest1 = (TileEntityChest) world.getTileEntity(new BlockPos(k9, y + 1, l9));
					LootStack loot = this.setItems(random);
					...
					if (i10 == 0)
					{
						...
						{
							if (k10 == 0) {
								genHelper.setBlock(x + 2, y + 1, z - 1 - j10, Blocks.OAK_FENCE);
							}
							if (k10 == 1) {
								genHelper.setBlock(x + 3 + j10, y + 1, z - 4, Blocks.OAK_FENCE);
							}
							if (k10 == 2) {
								genHelper.setBlock(x + 6, y + 1, z - 1 - j10, Blocks.OAK_FENCE);
							}
							j10++;
							if (j10 == 4)
							{
						...
						if (k11 == 0)
						{
							...
							TileEntityChest chest2 = (TileEntityChest)world.getTileEntity(new BlockPos(x + 3, y + 1, z - 3));
